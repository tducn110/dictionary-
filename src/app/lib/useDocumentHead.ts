...
export function useDocumentHead() {
  ...
  useEffect(() => {
    ...
    themeColor.content = appMetaContent.themeColor;
    ...
    viewport.content = appMetaContent.viewport;

    // OG / social meta
    const metas: Record<string, string> = {
      'description': appMetaContent.description,
      'og:title': appMetaContent.title,
      'og:description': appMetaContent.description,
      'og:type': appMetaContent.ogType,
      'twitter:card': appMetaContent.twitterCard,
      'twitter:title': appMetaContent.title,
    };
